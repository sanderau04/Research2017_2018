...
if(choice == 1)
    ...
    [noiseThresholdWavPos, noiseThresholdWavNeg] = findThresholdLive(recObj); %return noise thresholds from 5 seconds of speech absent audio recording
...
[analysisTableDetails, analysisTableSummary, debuggingTable] = speechPauseAnalysis(detectionWTime,...
    noiseThresholdWavPos,...
    noiseThresholdWavNeg); %return 3 tables of specific speech analysis featurs, save xlsx file of all tables
