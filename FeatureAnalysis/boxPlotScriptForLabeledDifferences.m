...
for i = 1:length(matFiles)
    ...
    tits = [audioName, ' IntDx: ', string(pDx(73))];
    
    figure
    boxplot(freqAll, Tall,'Labels', {'P: Max Freq','C: Max Freq','B: Max Freq','O: Max Freq', 'P: Mean Freq', 'C: Mean Freq',  'B: Mean Freq', 'O: Mean Freq'})
    title(tits)
    ylabel('Frequency (Hz)')
    
    clear pDx feat epoch audioName T T2 Tall temp maxFreq meanFreq indSpeechStart tits freqAll
end
