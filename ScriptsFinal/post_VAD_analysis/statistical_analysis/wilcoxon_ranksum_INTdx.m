%% wilcoxon_ranksum_INTdx.m performs wilcoxon rank sum test on summary features 
% and patient internal diagnosis. 

%% Required patient mat file variables:
% patientDx, analysisTableSpeechDetails, analysisTableSummary
...
%% Divide mat data based on patient internal diagnosis
...
%% Extract features for both mat data INTdx categories
