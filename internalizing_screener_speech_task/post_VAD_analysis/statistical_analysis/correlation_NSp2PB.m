%% NSp2PBCorr.m performs initial spearman correlations with 
% PDx NSp2PB and sumamry features ONLY.
...
for i = 1:length(matData)
    externalTmerged(i) = matData(i).patientDx(225);
...
%% Run spearman correlations on features and NSp2PB
